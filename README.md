...
It means that every element that we use have a meaning and represents something in the webpage. and using semantic tags you provide additional information when reading the code.


2. Name two big differences between ```display: block;``` and ```display: inline;```.
block takes a whole line and in line takes just the space it needs.
...
because everyone can work freely on different parts of the project.
